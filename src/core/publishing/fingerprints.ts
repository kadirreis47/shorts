...
export function artifactFingerprint(artifact: ExportArtifact): string { return stableId('publish-artifact', `${artifact.path}:${artifact.sizeBytes}:${artifact.durationMs}:${artifact.verified}:${JSON.stringify(artifact.diagnostics)}`); }
