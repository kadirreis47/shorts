...
const oauth = loadLocalYouTubeOAuthConfig(); const env = { ...process.env, ...(oauth.clientId ? { SHORTSFLOW_YOUTUBE_CLIENT_ID: oauth.clientId } : {}), ...(oauth.clientSecret ? { SHORTSFLOW_YOUTUBE_CLIENT_SECRET: oauth.clientSecret } : {}) };
