...
export async function editingFixture() { const media = createMediaEngine(new TypedEventBus<ApplicationEventMap>(), assets); const result = await media.buildProject({ projectId: 'editing-project', title: 'Editing', scenes: [
  { sceneId: 'visual-scene-00000000-0000-4000-8000-000000000001', text: 'İlk 3 saniyede sonucu görün!', duration: 3, visual: 'Dynamic hook', keywords: ['sonuç', 'hızlı'] },
  { sceneId: 'visual-scene-00000000-0000-4000-8000-000000000002', text: 'Bu uzun sahne birinci fikri anlatır. Ardından ikinci önemli fikri ayrıntılı açıklar.', duration: 8, visual: 'Explanation', keywords: ['açıklama'] },
  { sceneId: 'visual-scene-00000000-0000-4000-8000-000000000003', text: 'Daha fazlası için takip et.', duration: 3, visual: 'CTA', keywords: ['takip'] },
